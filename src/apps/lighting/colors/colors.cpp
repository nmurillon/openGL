...
int main(int argc, char **argv) {
  ...
  // SETUP SHADERS
  // const libs::renderer::Shader shaderCube("shaders/basicShader.vert",
  //                                         "shaders/lightSource.frag");

  // const libs::renderer::Shader shaderLight("shaders/basicShader.vert",
  //                                          "shaders/light.frag");
  ...
  //                  mesh::lighting::verticesWithColors.size() *
  //                  sizeof(float)),
